...
Medio de Palenque. Sitio público + `/admin` en Next.js. UI en español. Nombre con **k**. Dominio: [elchakero.com](https://elchakero.com).
...
- Portada con pregón, secciones, agenda, archivo `/pregon/`, páginas fijas.
...
4. SQL editor: correr las migraciones de `supabase/migrations/` en orden.
...
No hay grafía cerrada de la escuela más allá de lo ya publicado, ni analítica de terceros.
